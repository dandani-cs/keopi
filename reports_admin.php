<?php
    ...
    function print_monthly_visualizations()
    {  
        print "
            labels   = Array(30).fill().map((element, index) => index + 1);
            datasets = 
...
<html lang="en">
    ...
    <body>
            ...
            <div class="row gx-5">
                                ...
                                if (!empty($filtered_data)) {
                                    ...
                                    foreach ($filtered_data as $transaction) {
                                        ...
                                        if (isset($product_stats[$product_name])) {
                                            ...
                                            $product_stats[$product_name]['dates'][ ] = $transact_date->format('d');
                                        } else {
                                            $product_stats[$product_name]['qty']   = 1;
                                            $product_stats[$product_name]['price'] = $transaction['price'];
                                            $product_stats[$product_name]['dates'] = array($transact_date->format('d'));
                                        }
                ...
                <div class="col-sm-4 side-content">
                    <div class="order-details-tab">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4> Daily Summary </h4> <!-- RIght bar title -->
                            </div>
                        </div>
        ...
        <script>
            ...
            transactions = <?php print !empty($filtered_data) ? json_encode($filtered_data, JSON_FORCE_OBJECT) : "{}" ?>;

            <?php
            if (!empty($filtered_data)) {
                print_visualizations();
            }
            ?>
