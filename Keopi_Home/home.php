...
<!-- //start about -->
 <div class="about-wthree" id="about">
	  <div class="container">
		<center><img src="logo.png" align="center" alt="Logo" height="500" width="350"/></center>	
				...
				<!-- Trigger the Modal -->
				<center>
					<img id="myImg" src="menu.png" alt="Keopi Menu" style="width:700%;max-width:500px">
...
span.onclick = function() {
  modal.style.display = "none";
			...
			<center><h2>WHAT WE SELL</h2></center>
			<br>
				<div class="container">
				<center>
				  ...
				  <div class="mySlides">
					<div class="numbertext">1 / 4</div>
					  <img src="caramel.jpg" style="width:100%">
				  </div>

				  <div class="mySlides">
					<div class="numbertext">2 / 4</div>
					  <img src="chocolatechip.jpg" style="width:100%">
				  </div>

				  <div class="mySlides">
					<div class="numbertext">3 / 4</div>
					  <img src="eggbaconcheese.jpg" style="width:100%">
				  </div>

				  <div class="mySlides">
					<div class="numbertext">4 / 4</div>
					  <img src="strawberrymilk.jpg" style="width:100%">
				  </div>
				</center>
				  ...
				  <div class="row">
					<div class="column">
					  <img class="demo cursor" src="caramel.jpg" height="300" width="250" onclick="currentSlide(1)" alt="Caramel">
					</div>
					<div class="column">
					  <img class="demo cursor" src="chocolatechip.jpg" height="300" width="250" onclick="currentSlide(2)" alt="Chocolate Chip">
					</div>
					<div class="column">
					  <img class="demo cursor" src="eggbaconcheese.jpg" height="300" width="250" onclick="currentSlide(3)" alt="Egg Bacon Cheese">
					</div>
					<div class="column">
					  <img class="demo cursor" src="strawberrymilk.jpg" height="300" width="250" onclick="currentSlide(4)" alt="Strawberry Milk">
					</div>
				  </div>
				  </center>
				</div>
